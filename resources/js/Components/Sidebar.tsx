...
export default function Sidebar() {
    return (
        <>
            <div className="this-is-the-sidebar min-h-screen w-64 z-50 fixed left-0 top-0 bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
                <div className="px-8">
                    ...
                    <ul className="mt-6">
                        ...
                        {navLinks.map((link) => (
                            <NavLink key={link.route} href={route(link.route)} active={route().current(link.route)} className="flex w-full justify-between items-center mb-6">
                                <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    ...
                                    <span className="text-sm ml-2">{link.name}</span>
                                </div>
